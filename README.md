...
🔗 [Acesse meu portfólio](https://gustavopessoa85.github.io/Meu-Portif-lio/)
...
[![Linkedin](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](http://linkedin.com/in/gustavo-pessoa-b8a878231)
...
**Desenvolvedor Back-end | Prolins Software House** (Agosto/2024 - Atual)

- 🏥 Desenvolvimento de sistemas para clínicas veterinárias e de cirurgia plástica
- 🔧 Responsável técnico: requisitos, prototipação, modelagem, desenvolvimento, deploy e suporte
- 🤖 Integrações com WhatsApp e IA para automação de alertas
- 📊 APIs RESTful com PHP (Laravel/CodeIgniter) e C# (.NET 8)
- 🚌 Sistema de gestão de transporte para eventos de grande porte
- 🐧 Gerenciamento de servidores Linux e versionamento de código
...
[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=GustavoPessoa85&layout=compact&theme=radical)](https://github.com/GustavoPessoa85)
...
Aprofundando conhecimentos em arquitetura de software, padrões de design e desenvolvimento full-stack.

---

## 🎯 Diferenciais

✅ Experiência completa no ciclo de vida do software  
✅ Comunicação direta com clientes  
✅ Autonomia técnica e visão de produto  
✅ Deploy e gestão de servidores Linux  
✅ APIs RESTful e integrações externas  
✅ Disponível para home office/híbrido  
